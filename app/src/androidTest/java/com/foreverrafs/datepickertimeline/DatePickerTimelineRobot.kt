...
internal fun BaseTest.datePickerTimeLineRobot(func: DatePickerTimelineRobot.() -> Unit) = DatePickerTimelineRobot(rule).apply {
    rule.waitForIdle()
    func()
}

internal class DatePickerTimelineRobot(
